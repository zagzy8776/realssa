    ...
    >
      <div className="flex flex-col w-full">
        ...
        <div className="w-full">
          <Link to={linkTo} onClick={handleClick} className="block w-full">
            <div 
              ...
              style={{ backgroundColor: '#F0F0F0', borderRadius: '12px 12px 0 0' }}
            >
              {hasImage ? (
                <img
                  src={imgSrc}
                ...
                <div className="flex items-center justify-center w-full h-full" style={{ color: '#AAAAAA' }}>
        ...
        <div className="px-4 pt-3 pb-1">
          ...
          >
            <Link 
              to={linkTo} 
              onClick={handleClick} 
              style={{ color: '#111111', textDecoration: 'none', display: 'block' }}
            >
        ...
        <div className="px-4 pt-2 pb-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3" style={{ color: '#AAAAAA', flexShrink: 0 }}>
            <button 
