        ...
        <div className="px-4 pt-3.5 pb-1">
          <h3 className="nr-headline text-base leading-snug m-0">
            <Link
              to={linkTo}
              onClick={handleClick}
              className="text-[#F1F1F3] hover:text-amber-500 transition-colors block decoration-none"
            >
        ...
        {storyHash && (
          <div className="px-4 pb-3 flex gap-2 text-xs">
            <button
              ...
              className={`px-3 py-1 rounded-full flex items-center gap-1 border transition-all duration-200 cursor-pointer text-[10px] font-bold ${hasVotedVerify
                ? 'bg-emerald-500/15 text-emerald-400 border-emerald-500/25'
                : 'bg-white/5 text-slate-300 border-white/5 hover:bg-emerald-500/10 hover:text-emerald-400'
                }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full flex items-center gap-1 border transition-all duration-200 cursor-pointer text-[10px] font-bold ${hasVotedVerify
                ...
                : 'bg-white/5 text-slate-300 border-white/5 hover:bg-red-500/10 hover:text-red-400'
                }`}
            >
              ⚠ {rumorCount} Rumor
            </button>
