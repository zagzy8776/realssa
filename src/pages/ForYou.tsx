...
const ForYou: React.FC = () => {
  ...
  let timeOfDayGreeting = "For You";
  if (currentHour < 12) timeOfDayGreeting = "Morning Brief";
  else if (currentHour < 18) timeOfDayGreeting = "Afternoon Digest";
  else timeOfDayGreeting = "Evening Recap";
