...
const contactCards = [
  {
    ...
    email: "realssanews@realssanews.com.ng",
  },
  {
    emoji: "🎤",
    title: "Artist & Talent",
      ...
      <section className="py-12 md:py-20 bg-gradient-to-b from-card to-background">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-4">
            Contact <span className="text-gradient-gold">RealSSA News</span>
          </h1>
          ...
          <article className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-card p-6 rounded-xl border border-border">
                <h3 className="text-primary font-semibold mb-4">📍 Lagos, Nigeria (HQ)</h3>
                <p className="text-muted-foreground mb-1">RealSSA News Limited</p>
                <p className="text-muted-foreground mb-1">Ikeja, Lagos State</p>
                <p className="text-muted-foreground mb-1">Nigeria</p>
                <p className="text-muted-foreground mb-1">📞 Phone: +234 80 1234 5678</p>
                <p className="text-muted-foreground">⏰ Hours: Mon-Fri, 9:00 AM - 5:00 PM WAT</p>
              </div>
              <div className="bg-card p-6 rounded-xl border border-border">
                <h3 className="text-primary font-semibold mb-4">📍 Accra, Ghana</h3>
                <p className="text-muted-foreground mb-1">RealSSA News Bureau</p>
                ...
                <p className="text-muted-foreground">⏰ Hours: Mon-Fri, 9:00 AM - 5:00 PM GMT</p>
              </div>
            </div>
