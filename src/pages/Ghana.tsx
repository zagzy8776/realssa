...
const Ghana = () => {
  ...
  useEffect(() => {
    const fetchGhanaNews = async () => {
      ...
      setError(null);
      try {
        const response = await fetch(apiUrl('/api/news/ghana'));
        if (response.ok) {
      ...
      <section className="relative overflow-hidden mb-12">
        <div className="absolute inset-0">
          <SimpleImage
            ...
            fallback="https://placehold.co/1920x1080/000000/ffffff?text=Ghana+News"
          />
              ...
              <article key={news.id} className="bg-card rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="relative mb-4">
                  <SimpleImage
                    ...
                    fallback="https://placehold.co/400x200/000000/ffffff?text=Ghana+News"
                  />
