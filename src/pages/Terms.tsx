...
const termsContent = [
  {
    ...
    content: "By accessing or using the RealSSA News website (the \"Site\"), you agree to be bound by these Terms of Service (\"Terms\") and all applicable laws and regulations. If you do not agree with these Terms, you are prohibited from using or accessing this Site.",
  },
  {
  ...
  },
  {
    ...
    content: "By submitting content to the Site (including but not limited to comments, articles, photos, or videos), you grant RealSSA News a worldwide, royalty-free, perpetual, irrevocable, non-exclusive, transferable, and sublicensable right and license to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, perform, and display such content (in whole or in part) worldwide and/or to incorporate it in other works in any form, media, or technology now known or later developed.",
  },
  {
    title: "5. Disclaimer of Warranties",
    content: "The Site is provided on an \"as is\" and \"as available\" basis. RealSSA News makes no representations or warranties of any kind, express or implied, as to the operation of the Site or the information, content, materials, or products included on this Site.",
  },
  {
    title: "6. Limitation of Liability",
    content: "In no event shall RealSSA News, its affiliates, or their respective directors, employees, agents, or representatives be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the Site.",
  },
  {
    title: "7. Indemnification",
    content: "You agree to indemnify, defend, and hold harmless RealSSA News, its affiliates, and their respective directors, officers, employees, agents, and representatives from and against any and all claims, liabilities, damages, losses, costs, expenses, or fees arising out of or relating to your use of the Site.",
  },
  {
    title: "8. Third-Party Links",
    content: "The Site may contain links to third-party websites that are not owned or controlled by RealSSA News. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites.",
  },
  {
    title: "9. Termination",
  ...
  {
    title: "12. Contact Us",
    content: "If you have any questions about these Terms, please contact us at realssanews@realssanews.com.ng.",
  },
];
