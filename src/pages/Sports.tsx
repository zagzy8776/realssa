...
import { Search, ExternalLink, Clock, Calendar, Trophy, Target, Users, Zap } from "lucide-react";
      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground">Fetching latest Sports news...</p>
          </div>
        </div>
      </div>
    );
  ...
  if (articles.length === 0) {
    return (
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4 text-red-600">No Sports Articles Found</h2>
            <p className="text-muted-foreground mb-6">
              The API returned data but no articles match the sports feeds filter.
            </p>
            <Button onClick={() => window.location.reload()}>
              Refresh Page
            </Button>
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Latest sports updates and scores</p>
        </div>
        ...
        {filteredArticles.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredArticles.map((article, index) => (
              <Card key={article.id || index} className="hover:shadow-lg transition-shadow">
                <img
                  src={article.image || 'https://placehold.co/400x250/FFA500/000000?text=Sports+News'}
                  alt={article.title}
                  className="w-full h-48 object-cover"
                  onError={(e) => {
                    e.currentTarget.src = 'https://placehold.co/400x250/FFA500/000000?text=Sports+News';
                  }}
                />
                <CardHeader>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">No sports articles found</h3>
            <p className="text-muted-foreground mb-6">
