...
const FEEDS = {
  ...
  usa: ['https://feeds.bbci.co.uk/news/world/us_and_canada/rss.xml','https://www.pbs.org/newshour/feeds/rss/headlines','https://feeds.nbcnews.com/nbcnews/public/news','https://abcnews.go.com/abcnews/topstories','https://news.google.com/rss/search?q=US%20news&hl=en-US&gl=US&ceid=US%3Aen'],
...
function publishedDate(item){ if(!item.pubDate) return null; const d=new Date(item.pubDate); return Number.isNaN(d.getTime())?null:d; }
